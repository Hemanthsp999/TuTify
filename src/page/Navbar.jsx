  ...
  return (
    <>
      <div className=" w-full flex justify-around text-3xl py-6 gap-2 bg-blue-600" >
        ...
        <div className=" mx-4">
          <Link to="/home" className=" mx-2 hover:text-orange-500 hover:bg-green-300 px-2 rounded-2xl text-white font-bold">Home</Link>
      ...
      <div>
        <h1 className=" mx-64 my-40 flex font-bold text-9xl text-black w-82 rounded-xl hover:text-blue-500 ">WEL COME TO OUR APP</h1>
      </div>
    </>
  )
}
