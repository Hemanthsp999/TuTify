    ...
    return (
        <>
            ...
            <div className=" grid grid-cols-2 gap-4">
                ...
                <div>
                    <p className=" my-72 mx-24 text-4xl italic hover:text-red-700 font-semibold">Unlock Your Learning Potential with Tutify: Where Knowledge Meets Personalized Guidance!</p>
                </div>
            </div>
        </>
    )
